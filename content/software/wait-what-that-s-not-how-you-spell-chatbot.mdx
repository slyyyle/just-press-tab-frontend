...
{/* The CollapsibleHeader component will be made available by the page rendering this MDX. */}
{/* The expandedSections logic for this specific article is managed by the client component rendering this MDX. */}
