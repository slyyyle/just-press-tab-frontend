    ...
    <main className="min-h-screen bg-background py-16 px-4 software-theme">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-card border-2 border-primary rounded-md overflow-hidden pixel-corners p-6 mb-12">
          <h2 className="font-press-start-2p text-2xl mb-6 text-[hsl(var(--primary))]">Web Development</h2>
          <div className="space-y-4">
            {webDevContent.map((item) => (
              <div
                key={item.id}
        ...
        {/* AI Engineering */}
        <div className="bg-card border-2 border-primary rounded-md overflow-hidden pixel-corners p-6 mb-12">
          <h2 className="font-press-start-2p text-2xl mb-6 text-[hsl(var(--primary))]">AI Engineering</h2>
          <div className="space-y-4">
            {cliToolsContent.map((item) => (
              <div
                key={item.id}
                className="flex flex-col p-3 bg-muted/50 rounded-md transition-colors hover:bg-primary/10 mb-2"
              >
                ...
                {item.articles && (
                  <div className="mt-2 ml-6 p-2 bg-background rounded border border-dashed border-[hsl(var(--primary))]">
                    <div className="flex flex-col divide-y divide-[hsl(var(--primary))]">
                      {item.articles.map((articleTitle) => (
                        <Link
                          key={articleTitle}
        ...
        <div className="bg-card border-2 border-primary rounded-md overflow-hidden pixel-corners p-6 mb-12">
          <h2 className="font-press-start-2p text-2xl mb-6 text-[hsl(var(--primary))]">System Customization</h2>
          <div className="space-y-4">
            {systemCustomContent.map((item) => (
              <div
                key={item.id}
                className="flex flex-col p-3 bg-muted/50 rounded-md transition-colors hover:bg-primary/10 mb-2"
              >
